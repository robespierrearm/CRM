-- Update tenders policies for admin access
...
-- New policies: admins see everything, users see only their own
CREATE POLICY "Users and admins can view tenders"
ON public.tenders
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "Users and admins can create tenders"
ON public.tenders
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "Users and admins can update tenders"
ON public.tenders
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "Users and admins can delete tenders"
ON public.tenders
FOR DELETE
TO authenticated
USING (
...
CREATE POLICY "Users and admins can create expenses"
ON public.expenses
FOR INSERT
TO authenticated
WITH CHECK (
...
-- Update incomes policies for admin access
...
CREATE POLICY "Users and admins can view incomes"
ON public.incomes
FOR SELECT
TO authenticated
USING (
...
CREATE POLICY "Users and admins can create incomes"
ON public.incomes
FOR INSERT
TO authenticated
WITH CHECK (
...
CREATE POLICY "Users and admins can update incomes"
ON public.incomes
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "Users and admins can delete incomes"
ON public.incomes
FOR DELETE
TO authenticated
USING (
